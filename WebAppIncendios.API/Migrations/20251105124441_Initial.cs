        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Direccion = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Productos = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DetallesVenta_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HorarioVisitas = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dispositivos_Proveedores_ProveedorId",
                        column: x => x.ProveedorId,
                        principalTable: "Proveedores",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Dispositivos_Ventas_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetallesVenta_ClienteId",
                table: "DetallesVenta",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_ProveedorId",
                table: "Dispositivos",
                column: "ProveedorId");

            migrationBuilder.CreateIndex(
                name: "IX_Dispositivos_VentaId",
                table: "Dispositivos",
                column: "VentaId");
